  ...
  <div class="content-wrapper px-4">
    <section class="content-header px-0">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button class="btn btn-info flex items-center gap-2" id="print">
...
<script>
    document.querySelector('#print').addEventListener('click', function() {
      ...
      printWindow.document.write('<link href="<?php echo URLROOT;?>/css/output.css" rel="stylesheet">'); // Include your CSS
